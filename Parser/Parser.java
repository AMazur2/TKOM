...
public class Parser{
    ...
    public HashMap<String, ClassStatement> getClasses() { return this.classes; }
    ...
    private boolean isToken(TokenTypes expected, Token t) { return expected.equals(t.getName()); }
    ...
    public Expression parseFloorOperatorT() throws Exception { return parseFloorOperator(); }
    public Expression parseFunctionCallT() throws Exception { return parseFunctionCall(); }
    public Expression parseMethodCallT() throws Exception { return parseMethodCall(); }
    public Statement parseReturnT() throws Exception { return parseReturn(); }
    public Expression parseHighOperatorOpExpressionT() throws Exception { return parseHighOperatorOpExpression(); }
    public Expression parsePowerExpressionT() throws Exception { return parsePowerExpression(); }
    public Expression parseModExpressionT() throws Exception { return parseModExpression(); }
    public Expression parseMultExpressionT() throws Exception { return parseMultExpression(); }
    public Expression parseAddExpressionT() throws Exception { return parseAddExpression(); }
    public Expression parseConditionT() throws Exception { return parseCondition(); }
    public Expression parseNotConditionT() throws Exception { return parseNotCondition(); }
    public Expression parseAndConditionT() throws Exception { return parseAndCondition(); }
    public Expression parseOrConditionT() throws Exception { return parseOrCondition(); }
    public Vector<Statement> parseAssignmentOrVarDeclarationT() throws Exception { return parseAssignmentOrVarDeclaration(); }
    public Statement parseForT() throws Exception { return parseFor(); }
    public Statement parseIfT() throws Exception { return parseIf(); }
    public Statement parseWhileT() throws Exception { return parseWhile(); }
}